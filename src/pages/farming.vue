<template>
  <div class="farm-page">
    <div class="container">
      ...
      <h1 class="farm-title">cupcake Farm on BurgerSwap</h1>
      <div class="farm-data">
        <div class="farm-data__top">
          ...
          <div class="farm-data__top-center">
            <div class="farm-data__top-center-content">
              ...
              <div class="pair">
                <div class="cupcake">
                  <img src="/pics/cupcake.png" alt="cupcake">
                </div>
          ...
          <div class="farm-data__top-side">
            <h2 class="title">Daily bcupcake Pool Rewards</h2>
            <span class="value">25 000 bcupcake</span>
          </div>
        </div>
      ...
      <h2 class="farm-label">Add Liquidity to <a :href="pairLink">{{ pair }} on BurgerSwap</a> pool to farm bcupcake!</h2>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  computed: {
    ...
    pairLink() {
      if (this.$route.name == 'farming burger')
        return 'https://burgerswap.org/?type=1&from=BURGER&to=bcupcake'
      else if (this.$route.name == 'farming bnb')
        return 'https://burgerswap.org/?type=1&from=BNB&to=bcupcake'
