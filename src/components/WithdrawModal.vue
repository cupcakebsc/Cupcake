    ...
    <div class="modal-box " v-if="show" @click.self="closeModal">
      ...
      <div class="modal">
        ...
        <div class="modal__container">
          <div class="modal__title">Withdraw bcupcake-BNB LPs Tokens</div>
          <div class="modal__inner">
            <div class="deposit">
              <div class="deposit__range">
                <div class="deposit__text">Withdraw bcupcake-BNB LPs</div>
                <div class="deposit__text deposit__text--black">{{ toFixedTwo(cupcakeFarmBalance / 1e18) }}</div>
              </div>
...
export default {
  ...
  methods: {
    ...
    maxOut() {
      this.amount = this.cupcakeFarmBalance / 1e18;
    },
